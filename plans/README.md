...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-09-16-1649-narrative-video-production-workflow/_plan.md`](active/2026-09-16-1649-narrative-video-production-workflow/_plan.md) | in-progress（Phase 1 invariants） | Architecture = ready／schema = experimental。Selection = 明示 policy。十條 invariant 見 `03-architecture-invariants.md`。不做工具、不接 runtime。 |
