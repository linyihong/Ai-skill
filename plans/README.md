...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow.md`](active/2026-08-31-1032-3d-character-production-workflow.md) | draft（Phase 0 裁決完成） | 3D Character Production：architecture shape Ready；Q1–Q8 已裁決（domain=`3d-character-production`；completion=`runtime-ready`=blocking+runtime+classified defects；Identity 拆 Lock/Acceptance；full-body required；fresh review=completion；Q6 second profile deferred；handoff 併入 artifact-gates）。**尚未進 Phase 1**。 |
