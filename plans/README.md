...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：Phase 0–2 **complete**（inferability：Selection/Family/Near Neighbor；10/10 rule-trace+blind）。Phase 3 = **Pattern Composition**（Episode Page 先行；entry freeze → `composition_rules`）。 |
