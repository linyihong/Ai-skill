...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-09-16-1649-narrative-video-production-workflow/_plan.md`](active/2026-09-16-1649-narrative-video-production-workflow/_plan.md) | in-progress（Phase 3 dogfood） | Phase 1–2 PASS（`34f778d4`+`8757a578`）。真實片子驗證契約；不改架構、不註冊 route。協議 `04-phase-3-dogfood.md`。 |
