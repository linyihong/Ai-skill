...
| `validatePlanEvidenceConvention` | block | `evidence/` 使用時 README + Run 索引同步（見 [`governance/lifecycle/plan-evidence.md`](../governance/lifecycle/plan-evidence.md)） |
...
| `validatePlanEvidenceConvention` | commit-msg **block**：staging `evidence/**` 時 README 存在且索引覆蓋所有 `.md` |
...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：workflow 可消費的選型／組成／展開知識層（非 NameThatUI clone）。Phase 0 complete（2026-07-14）；掛 `ui-contracts` Lock；Core/Extended + evidence_level；doc-only 至 D9 Promote。Phase 1 未開始。 |
