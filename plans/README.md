...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：P2 Inferability ✓；P3 Composability **started**（Invariant=no entry back-propagation；H4–H6 分型；exit=Composition Closure；非「完成 Screen」）。 |
