...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 0–2：architecture closed；scenarios RED；`contracts/` draft） | 3D Character Production。Phase 1 fail-by-absence。Phase 2 record shapes 在 plan `contracts/`（不投影）。**未寫 workflow / glossary / route**。 |
