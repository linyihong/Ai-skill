...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 0–2.5：contracts landed；probe fillable；Phase 3 未授權） | 3D Character Production。Phase 1 intentionally RED。Phase 2 `contracts/` 不投影。Phase 2.5 結論在 `evidence/`。**未寫 workflow / glossary / route**。 |
