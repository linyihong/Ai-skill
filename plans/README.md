...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：P3 Composability（constraints；H4→H5→H6 **mini-cycles**；Metrics；Invariant；Composition Closure；Layer Growth Rhythm → Architecture Evolution Protocol）。 |
