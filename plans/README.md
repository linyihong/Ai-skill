...
| [`active/2026-09-22-1000-translation-decision-workflow/_plan.md`](active/2026-09-22-1000-translation-decision-workflow/_plan.md) | in-progress（Phase 2 adapter） | Translation Decision：I1–I11；靜態走讀 A+B PASS（[`08`](active/2026-09-22-1000-translation-decision-workflow/08-static-walkthrough-pass.md)）；subtitle → NVP `content_gate`。 |
