...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：Phase 0–1 complete；Lock + frozen Core v1 + 五件 overlay seeds + `pattern-index` + `validation/entry-schema`。Phase 2 = **同五件** dogfood 驗形狀（不堆新 entry）。 |
