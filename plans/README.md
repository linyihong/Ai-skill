...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-09-16-1649-narrative-video-production-workflow/_plan.md`](active/2026-09-16-1649-narrative-video-production-workflow/_plan.md) | in-progress（Phase 2 contract） | `workflow/narrative-video-production/` 已寫；未註冊 route、未投影。下一步 Phase 3 真實 EDR dogfood。 |
