...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow/_plan.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow/_plan.md) | in-progress | UI Pattern：RC2-P1 🟢 Stable；RC2-P2 ▶ Inferability（`payment_leave_transition`）。 |
