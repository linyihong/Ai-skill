...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge：workflow 可消費的選型／組成／展開知識層（非 NameThatUI clone）。**Phase 0–1 complete**（2026-07-14）：templates + `ui-contracts` Lock + overlay Core seeds×5；doc-only 至 D9 Promote。Phase 2 dogfood 未開始。 |
