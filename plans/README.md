...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 3 correction validated；dogfood 未開始） | Body deformation／facial acceptance 已拆分；觸發口令「跑 execution dogfood」後驗十一條；Phase 4／5／6 blocked。 |
