...
| [`active/2026-07-14-0856-ui-pattern-knowledge-workflow.md`](active/2026-07-14-0856-ui-pattern-knowledge-workflow.md) | in-progress | UI Pattern Knowledge ladder：P1 Representability→P2 Inferability（✓）→P3 **Composability**（Screen；H4–H6；Episode only；Composition Constraints；entry freeze）。 |
