...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow.md`](active/2026-08-31-1032-3d-character-production-workflow.md) | in-progress（Phase 0 closed；Phase 1 scenarios 已寫） | 3D Character Production：architecture Ready；Phase 1 fail-by-absence YAML 在 `validation/scenarios/3d-character-production/` + detector。**尚未寫 workflow 正文（Phase 3）**。 |
