...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 3 core landed；route／projection 未做） | 3D Character Production workflow 執行層。detector 應仍 no_match。Invalidation SoT 在 `workflow/.../records/identity-acceptance.yaml`。 |
