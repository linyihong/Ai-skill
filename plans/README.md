...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 3 implementation landed ≠ validated；route 未登記） | detector no_match EXPECTED。下一驗證若授權：execution dogfood 停／放行，不是再寫 workflow。 |
