...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 2.5 contract probe PASS ≠ workflow PASS；Phase 3 未授權） | 3D Character Production。detector/workflow intentionally RED。contracts frozen、不投影。**未寫 workflow / glossary / route**。 |
