...
| [`active/2026-09-22-1000-translation-decision-workflow/_plan.md`](active/2026-09-22-1000-translation-decision-workflow/_plan.md) | in-progress（Phase 0 freeze） | Translation Decision Workflow：I1–I10 邊界釘死（[`06`](active/2026-09-22-1000-translation-decision-workflow/06-phase-0-freeze-invariants.md)）；**陈小姐→id-ID** = P0 regression；進 Phase 1 doc-only contracts。 |
