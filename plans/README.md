...
| [`active/2026-07-08-0825-delegation-verification-arbitration-loop/_plan.md`](active/2026-07-08-0825-delegation-verification-arbitration-loop/_plan.md) | in-progress | Delegation Verification & Arbitration Loop：三角色委派閉環（orchestrator 規劃/切分/仲裁不執行、executor 憑 brief、verifier fresh-context 只產證據）。**Execute 意圖 = mandatory loop**（2j 裁決）；dogfood 2a–2q（17 runs：正向閉環 2n/2p、負向 2j/2l/2q、跨域 2e、falsification 2f 預註冊）→ 證據在 `evidence/`。研究線：ERA（Evidence constrains Decision，v2 凍結為工作模型、v3 候選）+ Phase 3 三分類決策框架，批次裁決 deadline 2026-08-31。doc-only、不動 schema、不建自動 orchestrator。 |
