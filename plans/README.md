...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`archived/2026-06-22-1009-plans-system-portability-and-delivery-integration/_plan.md`](archived/2026-06-22-1009-plans-system-portability-and-delivery-integration/_plan.md) | ✅ completed (auto-detected) | Plans System Portability & Delivery Integration：01 portable validation via shared binary（2026-07-03）、02 software-delivery plan-first ordering（2026-07-08）、03 delegation schema + 雙路徑 dogfood（2026-07-06）。Q8 external schema policy deferred；ADR 不 promote。 |
