...
| 檔案 | 狀態 | 說明 |
|------|------|------|
| [`active/2026-08-31-1032-3d-character-production-workflow/_plan.md`](active/2026-08-31-1032-3d-character-production-workflow/_plan.md) | in-progress（Phase 3 landed ≠ validated；`5abffb7a`） | dogfood 未開始。觸發口令「跑 execution dogfood」後只驗七條；Phase 4／5 blocked。 |
