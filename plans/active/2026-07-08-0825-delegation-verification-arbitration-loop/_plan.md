...
- [`active/2026-07-30-0950-knowledge-governance-runtime/_plan.md`](../2026-07-30-0950-knowledge-governance-runtime/_plan.md) — **Knowledge Governance Engine (KGE)**：Knowledge Execution 對偶於本 plan 的 Task Execution（Delegation Loop）。共享候選 = Capability / Registry / Adapter / Findings；**不合併實作**（見 KGE §D7）。
