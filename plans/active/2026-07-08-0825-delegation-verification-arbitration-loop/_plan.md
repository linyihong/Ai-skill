...
revision:
  - date: 2026-07-23
    note: "Dogfood 3a — KaizenWMS spawn-friction／gate-misattribution 跳過三角色（负向）＋同日 shell-nav Phase 1 完整 O→E→V（正向）；portable §2.1 fallback；evidence/3a-…"
  - date: 2026-07-08
...
- [x] **3a — KaizenWMS spawn-friction／gate-misattribution 跳過 loop** — 2026-07-23（[`evidence/3a-kaizenwms-spawn-friction-skip-loop.md`](evidence/3a-kaizenwms-spawn-friction-skip-loop.md)）；負向：誤指 Ai-skill 擋三角色→同 session 直做；糾偏 portable §2.1＋同日 shell-nav Phase 1 完整 O→E→V；回饋 `spawn-friction-not-exemption`／`gate-misattribution`；**不**視為 Phase 3／Q5 closure
