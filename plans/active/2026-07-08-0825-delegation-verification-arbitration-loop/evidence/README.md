...
| **2w** | （啟動時新增 `2w-travel-planning-independent-verification.md`） | **預註冊** | Travel Planning：高風險路書獨立驗證委派；見 `_plan` Phase 2 與 `workflow/travel-planning/execution-flow.md` §17.1；不填 Knowledge |
