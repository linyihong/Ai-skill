...
> **Stage 2 跨域證據（Architecture）**。Subject：[`plans/archived/2026-07-14-0856-ui-pattern-knowledge-workflow/_plan.md`](../../../archived/2026-07-14-0856-ui-pattern-knowledge-workflow/_plan.md)（draft plan：Authority Boundary、Core/Extended schema、event-driven promote-or-sunset）。
