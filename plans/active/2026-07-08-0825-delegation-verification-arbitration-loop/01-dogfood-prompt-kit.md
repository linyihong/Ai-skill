...
- **相对 ExternalRepoC 2d**：同 consumer overlay + backfill 模式；差异 = 2g 为 filename+diff 渐进迁移；**2d′** 记录 ExternalRepoC 后续已落地 Java `manageCode/server/*/src/test/**` commit block（见 §2d′ #5）。
