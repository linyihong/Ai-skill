...
| interaction-hazard `2026-06-16` | Downstream pilot gate（A0–D，吃 ExternalRepoA commit） | primitive 值不值得升 O3 model？ | ADR criteria 1–6 |
...
| EL-8 | 2026-07-10 | negative-positive-pairing | 2j/2k/2l 负向链 + **2n** 正向链同域共读 | **配对证据**价值 > 单点 positive：consumer overlay 可纠偏可闭环。观察：应保留负向 run 不删除。无新 criterion；feed delegation Q5 信号（仍不足 promote schema）。 | soft | no |
