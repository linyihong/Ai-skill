...
Phase 3 觀察（**尚未**進 workflow）：角色顯示名見 [`05-series-cast-canonicalization.md`](05-series-cast-canonicalization.md)；機械事實層見 [`07-material-fact-extraction.md`](07-material-fact-extraction.md)；Face [`11-face-as-candidate-evidence.md`](11-face-as-candidate-evidence.md)；Voice [`14-voice-speaker-evidence.md`](14-voice-speaker-evidence.md)（`speaker_id` ≠ `character_id`）；證據收斂 [`12-evidence-refinement.md`](12-evidence-refinement.md)。
