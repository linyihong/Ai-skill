...
| `sanitization_auto_map` | 看到顯示詞就自動改 spoken，或只掃一次、不做整集複核 | **不是**立刻 `contract_gap`。`text_alert` 只 candidate；前警覺＋Final Text Audit；三級 risk。見 [`evidence/2026-09-21-sanitization-anomaly-audit.md`](evidence/2026-09-21-sanitization-anomaly-audit.md) |
