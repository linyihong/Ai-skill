...
- [ ] Subtitle layout engine：觀察中；glyph＋constraints＋profile；字級是 range＋scale＋fit；LLM 不斷行；V0 先於 obstruction；候選 invariant 14 未凍結
