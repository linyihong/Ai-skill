...
- [ ] Narrative representation：觀察中；Text Resolution → Narrative Window → Event Assembly；**spoken ≠ subtitle**；禁止 OCR 優先／原地改 ASR；無證據加長 → unresolved
