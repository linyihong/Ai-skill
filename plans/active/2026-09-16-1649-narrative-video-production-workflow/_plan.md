...
- [ ] Narrative representation：觀察中；Text Resolution（含 phonetic candidate）→ Narrative Window → Event Assembly；**spoken ≠ subtitle**；LLM 最後 ranking；sanitization 不凍結；無證據加長 → unresolved
