...
Phase 3：locale 的 `text_origin: ocr` ≠ 源片 **visual text evidence**。後者見 [`09-visual-text-evidence.md`](09-visual-text-evidence.md)。`layout_gate` 的 solver 候選：[`26-subtitle-layout-engine.md`](26-subtitle-layout-engine.md)。字級／行高同屬 layout profile：[`27-typography-layout-profile.md`](27-typography-layout-profile.md)。自製口播 cue 時軸：[`29-speech-timing-authority.md`](29-speech-timing-authority.md)。`max_lines` 上限：[`30-max-lines-is-bound.md`](30-max-lines-is-bound.md)。字級硬閘：[`31-font-size-hard-bounds.md`](31-font-size-hard-bounds.md)。語意安全換行／cue 統一字級：[`32-semantic-safe-wrap-uniform-typography.md`](32-semantic-safe-wrap-uniform-typography.md)。Caption Composition／scored 斷點：[`33-caption-composition-semantic-breaks.md`](33-caption-composition-semantic-breaks.md)。
