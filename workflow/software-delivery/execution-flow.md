...
> | Implementation（執行核心） | [`implementation/README.md`](implementation/README.md)（含 [`execution-modes.md`](implementation/execution-modes.md)、[`multi-repository-workspace-mode.md`](implementation/multi-repository-workspace-mode.md) 多倉庫處理模式） | `sd-implementation` | 實際進行程式碼變更 |
