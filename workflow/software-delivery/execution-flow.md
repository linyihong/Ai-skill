...
> | Implementation（執行核心） | [`implementation/README.md`](implementation/README.md)（含 [`execution-modes.md`](implementation/execution-modes.md)、[`multi-repository-workspace-delivery.md`](implementation/multi-repository-workspace-delivery.md)） | `sd-implementation` | 實際進行程式碼變更 |
