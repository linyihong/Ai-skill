...
Script → Speech Unit Planning（語意邊界＋screen-fit＋max_lines／width＋語系）
  ...
  → Caption layout（font／break／safe area；另一條 loop）
```
...
- **Layout loop**：cue 吃真實時軸 → layout → visual review（[`28-layout-review-loop.md`](../../plans/active/2026-09-16-1649-narrative-video-production-workflow/28-layout-review-loop.md)）
