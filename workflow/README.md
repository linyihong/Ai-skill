...
- [`translation/`](translation/README.md)：**翻譯決策**（Context → Content-Type → Analysis → Candidate Space → Feasible → Selection → Finality）。I1–I12；title／content_type；**尚未**註冊 route。P0：陈小姐 id/ja + [`title-kongjie-yiriqianli`](translation/examples/title-kongjie-yiriqianli.yaml)。
