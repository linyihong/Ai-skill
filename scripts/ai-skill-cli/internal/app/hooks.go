...
// (portable/kge.AdaptiveTriggersRule). Opt-out: [skip-adaptive].
func validateAdaptiveTriggers(modes map[string]string, text string) string {
	return runKGEAdaptiveTriggers(modes, text)
}
