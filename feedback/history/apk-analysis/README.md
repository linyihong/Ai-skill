...
| Slug | Category |
|------|----------|
| `unity-il2cpp/2026-09-21_091600-slot-three-visual-planes-and-in-cabinet-anim-stack` | 同一 cabinet 三視覺平面；進桌動畫是 ID→Spine/Animator/Particle |
...
| `unity-il2cpp/2026-09-14_111500-unity-inline-icon-may-be-private-use-font-glyph` | 小圖示可能是 `UIText` Private Use Area 字型 glyph，不是獨立 Sprite |
