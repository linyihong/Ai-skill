...
| 分類 | 數量 | 說明 |
|------|------|------|
| [`common/`](common/) | 58 | 跨分類或通用 lesson（開發流程、契約治理、測試策略、後端架構、安全審計等） |
...
| Slug | Category |
|------|----------|
| `common/2026-09-15_112000-wire-rewards-parse-collapse-richest-block` | 只取最完整 REWARDS 块；解析 COLLAPSE/NEW，终盘反推爆裂盘面 |
