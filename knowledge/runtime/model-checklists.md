...
| `route.runtime.capability-context` | Primary: `runtime/capability-context.yaml`<br>Compression: `summary-first`<br>Required: `knowledge/runtime/capability-registry.yaml`<br>`governance/cognitive-stance.md`<br>`metadata/capability-context-schema.md`<br>Validation: ai-skill runtime validate passes capability_registry check; ai-skill runtime capability-invoke --capability <id> [--stance <v>] returns exit 0; missing required stance emits warning not auto-fill.  |
| `route.governance.cognitive-stance` | Primary: `governance/cognitive-stance.md`<br>Compression: `summary-first`<br>Required: `knowledge/runtime/capability-registry.yaml`<br>`metadata/capability-context-schema.md`<br>`runtime/capability-context.yaml`<br>Validation: stance_enum lists only fault_finding as standardized non-default value; governance invariant forbids consumer-owned stance contract and workflow stance branching; registry entries reference this contract.  |
...
| `route.knowledge.glossary` | Primary: `knowledge/glossary/ai-skill.md`<br>Compression: `source-backed`<br>Required: `knowledge/glossary/README.md`<br>Validation: Glossary entries 已通過 schema validator；SQLite projection 已 populated； term owner、relations、usage 可被 SQL 查詢；symmetric relation 雙向對稱。  |
...
| Route | Checklist |
| --- | --- |
| `route.workflow.apk-analysis` | Primary: `workflow/apk-analysis/execution-flow.md`<br>Compression: `source-backed`<br>Required: `workflow/apk-analysis/artifact-gates.md`<br>`workflow/apk-analysis/artifact-gates/ui-architecture-map.md`<br>`workflow/apk-analysis/artifact-gates/api-catalog.md`<br>`workflow/apk-analysis/artifact-gates/domain-runtime-baseline.md`<br>`workflow/apk-analysis/artifact-gates/feature-handoff.md`<br>`workflow/apk-analysis/artifact-gates/evidence-chain.md`<br>`workflow/apk-analysis/artifact-gates/sanitization.md`<br>`workflow/apk-analysis/artifact-gates/self-generation-audits.md`<br>`workflow/apk-analysis/artifact-gates/documentation-discipline.md`<br>`enforcement/README.md`<br>`enforcement/dependency-reading.md`<br>`enforcement/authorization-scope.md`<br>Validation: 新分層路徑可讀取，workflow 與 analysis 內容已分離；artifact-gates focused surfaces 可由同一 hierarchical route 找到。 |
...
| `route.workflow.legal` | Primary: `workflow/legal/execution-flow.md`<br>Compression: `source-backed`<br>Required: `workflow/legal/README.md`<br>`workflow/legal/intake.md`<br>`workflow/legal/risk-classification.md`<br>`workflow/legal/strategy/README.md`<br>`workflow/legal/artifact-gates.md`<br>Validation: Task type / jurisdiction / risk tier 三者已明說；Strategy 的 Decision Register 每個決策點四欄齊備（Recommendation / Reason / Alternative / Trade-offs）； 每筆法規或官方範本引用帶版本與查核日；Red tier 僅輸出 Escalation Card。  |
