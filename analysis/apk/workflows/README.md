...
| [`headless-sdk-device-executor-flow.md`](headless-sdk-device-executor-flow.md) | Private SDK 裝置執行器 — sign 已對齊但主機 403 時，冷啟 bootstrap → session → rewards E2E | `feedback/history/.../2026-07-15_140*` + `132500` |
