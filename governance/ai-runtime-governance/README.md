...
| [`cognitive-state-governance.md`](cognitive-state-governance.md) | [`cognitive-boundaries.md`](../../intelligence/engineering/agent-architecture/cognitive-boundaries.md), [`failure-recovery.md`](../../intelligence/engineering/agent-architecture/failure-recovery.md), [`context-collapse.md`](../../intelligence/engineering/agent-architecture/context-collapse.md) | 將 assumption lifecycle、evidence qualification、confidence integrity、claim scope、intent stability、autonomy mode、contamination boundary 與 minimal runtime primitive 轉成 cognitive state governance。 |
...
| [`cognitive-stance.md`](../cognitive-stance.md) | [`ADR-013`](../../constitution/ADR-013-cognitive-role-primitive-gate.md), [`ADR-014`](../../constitution/ADR-014-cognitive-stance-capability-context.md) | Capability `requires_context.stance` contract；fault_finding 認知立場；consumer 不得私有定義 stance。 |
